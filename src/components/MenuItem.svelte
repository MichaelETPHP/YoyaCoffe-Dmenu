...
<div class="menu-item group bg-white rounded-2xl shadow-soft overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-coffee-100">
  ...
  <div class="p-5">
    ...
    <div class="mt-2 inline-flex items-center px-2 py-1 bg-coffee-100 rounded-full">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-coffee-600 mr-1">
        {#if icon === 'coffee'}
      ...
      <span class="text-xs text-coffee-700">{icon.charAt(0).toUpperCase() + icon.slice(1)}</span>
    </div>
